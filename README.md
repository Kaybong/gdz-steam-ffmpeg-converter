# GDZ Steam FFmpeg Converter — Railway v1.0.4
...
- Видео перекодируется в H.264 High Profile/AAC, `1280×720`, `yuv420p`, `faststart`; широкий формат сохраняется для всех роликов.
